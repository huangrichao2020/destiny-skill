...
命运 Skill is not dating tactics and not manipulation.

It trains the user to:
...
When analyzing a case, use this structure unless the user asks for another format:
